# ============================================================
# SDID for FBG: Improved vs Stable (NDVI 1000m, 2014–2024)
...
# ------------------------------------------------------------
panel <- readRDS(
  "/Users/yqdai/Downloads/GreenSpace/data/D_all_SI_2019/panel_14_24_R1000_DTO_SEV.rds"
)
...
tiff(
  filename = "/Users/yqdai/Downloads/GreenSpace/sdid_fbg_strata_fbg_1000.tiff",
  width    = 10,
  height   = 16,
  units    = "in",
  res      = 300
