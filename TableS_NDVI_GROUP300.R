...
data_dir <- "/Users/yqdai/Downloads/GreenSpace/code/data"

my_list <- readRDS("/Users/yqdai/Downloads/GreenSpace/data/mydat_16T24NO23.rds")
...
summary_3grp <- desc_df %>%
  ...
  summarise(
    ...
    post_mean_val = mean(post_mean,    na.rm = TRUE),
    post_sd_val   = sd(post_mean,      na.rm = TRUE),
  ...
  mutate(
    ...
    post_mean_mean_sd  = fmt_pm_sd(post_mean_val, post_sd_val),
...
write.csv(summary_3grp, "/Users/yqdai/Downloads/GreenSpace/code/ndvi_summary_3groups.csv", row.names = FALSE)
