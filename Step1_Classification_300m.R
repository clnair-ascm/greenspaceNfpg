...
my_list$complete_2016_cleaned$label_300 <- NULL
my_list$complete_2016_cleaned$labels_1000 <- NULL
my_list$complete_2017_cleaned$label_300 <- NULL
my_list$complete_2017_cleaned$labels_1000 <- NULL
my_list$complete_2018_cleaned$label_300 <- NULL
my_list$complete_2018_cleaned$labels_1000 <- NULL
my_list$complete_2019_cleaned$label_300 <- NULL
my_list$complete_2019_cleaned$labels_1000 <- NULL
my_list$complete_2020_cleaned$label_300 <- NULL
my_list$complete_2020_cleaned$labels_1000 <- NULL
my_list$complete_2021_cleaned$label_300 <- NULL
my_list$complete_2021_cleaned$labels_1000 <- NULL
my_list$complete_2022_cleaned$label_300 <- NULL
my_list$complete_2022_cleaned$labels_1000 <- NULL
my_list$complete_2024_cleaned$label_300 <- NULL
my_list$complete_2024_cleaned$labels_1000 <- NULL
# ---- packages ----
