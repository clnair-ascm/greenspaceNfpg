...
# to Word (RTF)
tbl1 %>% as_flex_table() %>% flextable::save_as_docx(path = "/Volumes/shiz-wm-netzero/users/yuqing/daiyy/GreenSpace/fig/Table1_baseline_201612.docx")
