...
# ------------------------------------------------------------
panel <- readRDS(
  "/Users/yuqing/Downloads/GreenSpace/data/panel_16_24_R300_DTO_SEV.rds"
)
...
gg_fig1 <- ggplot(
  ...
  # Intervention line
  geom_vline(xintercept = 2020, linetype = "dashed", colour = "grey60") +
  # 95% CI ribbon
  geom_ribbon(
...
gg_fig2 <- synthdid::synthdid_plot(
  ...
  treated.name     = "Improved",
  control.name     = "Synthetic control",
  trajectory.alpha = 0.95,   # 原来默认 0.5，改深很多
  diagram.alpha    = 1,
  effect.alpha     = 1,
  onset.alpha      = 0.6,
  ci.alpha         = 0.45,
...
ggsave(
  filename = "/Users/yuqing/Downloads/GreenSpace/fig/FBG_raw_traj_improved_vs_stable.tiff",
  plot     = gg_fig1,
  width    = 6,
  height   = 4.5,
  units    = "in",
...
ggsave(
  filename = "/Users/yuqing/Downloads/GreenSpace/fig/FBG_sdid_overall.tiff",
  plot     = gg_fig2,
  width    = 6,
  height   = 4.5,
  units    = "in",
