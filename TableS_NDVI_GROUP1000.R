...
data_dir <- "/Users/yqdai/Downloads/GreenSpace/data"
...
desc_df <- lab %>%
  mutate(
    ...
    abs_change   = delta,
    rel_change   = 100 * delta / pmax(pre_mean, 1e-6)
  )
...
write.csv(
  summary_3grp,
  "/Users/yqdai/Downloads/GreenSpace/code/ndvi_summary_3groups_1000m.csv",
  row.names = FALSE
)
